...
<head>
    ...
    <title>Fornecedores | Mercearia</title>
</head>
<?php
    ...
    <div class="row">
        ...
        <div class="col-md-9 ml-auto col-lg-10 principal">
            <main role="main" class="m-2">
                ...
                ?>
                <h2 class="text-center mb-3">Tabela de Fornecedores</h2>
                ...
                <div class="table-responsive">
                    <table id="listar-fornecedores" class="table table-hover text-center tabela-personalizada">
                        <thead class="bg-info">
                            <tr>
                                <th>Id</th>
                                <th>Nome</th>
                        ...
                        <tbody>
                            ...
                            ?> <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo URL; ?>fornecedor/editar/&id=<?php echo $item['id'] ?>" class="btn btn-warning col-mb-3"><i class="fas fa-edit"></i></a>
                                    </td>
                                    <td>
                                        <a href="<?php echo URL; ?>fornecedor/excluir/&id=<?php echo $item['id'] ?>" class="btn btn-danger col-mb-3" id='link_excluir'><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
                ...
                <div class="modal fade" id="confirm-delete" tabindex="-1" aria-labelledby="modalExcluirFornecedor" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalExcluirFornecedor">Excluir fornecedor</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
